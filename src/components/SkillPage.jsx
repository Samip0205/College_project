...
const skillContent = {
  ...
  cooking: {
    ...
    youtube: 'https://www.youtube.com/watch?v=P6W8kwmwcno&t=3s'
  },
  guitar: {
  ...
  design: {
    ...
    youtube: 'https://www.youtube.com/watch?v=j6Ule7GXaRs&t=215s&pp=0gcJCcMJAYcqIYzvI'
  },
  photography: {
    title: 'Photography',
    ...
    youtube: 'https://www.youtube.com/embed/7ZVyNjKSr0M'
  },
  music: {
    title: 'Music',
    ...
    youtube: 'https://www.youtube.com/shorts/YGoIarkEGB4?feature=share'
  },
};
